...
export default function CategoriesPage({ categories }: CategoriesPageProps): JSX.Element {
  ...
  const handleCategoryClick = (slug: string, isTag: boolean = false) => {
    const path = isTag ? `/recipes/tag/${slug}` : `/recipes/category/${slug}`;
    router.push(path);
  };
  ...
  return (
    <Layout
      ...
      description="Explore our comprehensive collection of recipe categories including main dishes, dietary preferences, cuisines, and occasions."
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover recipes organized by type, dietary preferences, cuisine, and occasions to find exactly what you're looking for.
            </p>
          </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {categories.main.map((category) => (
                <div
                  key={category.slug}
                  onClick={() => handleCategoryClick(category.slug, false)}
                ...
                >
                  <span className="block text-5xl mb-4 group-hover:scale-110 transition-transform duration-200">
                    {category.icon}
                  </span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {categories.dietary.map((category) => (
                <div
                  ...
                  className="block bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-lg transition-shadow duration-200 group cursor-pointer"
                >
                  <span className="block text-4xl mb-3 group-hover:scale-110 transition-transform duration-200">
                    {category.icon}
                  </span>
          ...
          {/* Occasion Categories */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Occasions</h2>
